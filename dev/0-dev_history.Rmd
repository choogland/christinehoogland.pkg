...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Certification Level 2 - Developer - Exam",
    Description = "French Certification of Professional Qualification - Level 2 - Developer – Package creation",
    `Authors@R` = c(
      person("Christine", "Hoogland", email = "christine.hoogland@finddx.org", role = c("aut", "cre"), comment = c(ORCID = "0000-0002-7341-1551")),
      person(given = "FindDx", role = "cph")
    )
  )
)
